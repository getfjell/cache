...
describe('remove operation', () => {
  ...
  describe('input validation', () => {
    it('should throw error for null key', async () => {
      ...
      await expect(remove(invalidKey, context)).rejects.toThrow('Invalid key structure');
  ...
  describe('error handling', () => {
    ...
    it('should handle API errors with additional properties', async () => {
      ...
      await expect(remove(validKey, context)).rejects.toThrow('[remove] Operation failed: Detailed API error');
